...
//        });
    ...
    private static int resolveSeasonalFoliageColor(BlockState state, @Nullable BlockAndTintGetter blockGetter, @Nullable BlockPos pos, int tintIndex)
    {
        ...
        Holder<Biome> biome = (level != null && pos != null) ? level.getBiome(pos) : null;
        double x = pos != null ? pos.getX() : 0;
        double z = pos != null ? pos.getZ() : 0;

        return SeasonColorHandlers.getSeasonalColor(level, biome, x, z, SeasonColorHandlers.ResolverType.FOLIAGE);
    }
    ...
    private static int resolveSeasonalGrassColor(BlockState state, @Nullable BlockAndTintGetter blockGetter, @Nullable BlockPos pos, int tintIndex)
    {
        ...
        return SeasonColorHandlers.getSeasonalColor(level, biome, x, z, SeasonColorHandlers.ResolverType.GRASS);
    }
